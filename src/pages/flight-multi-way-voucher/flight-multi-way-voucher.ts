...
/**
 * Generated class for the FlightMultiWayVoucherPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-flight-multi-way-voucher',
  templateUrl: 'flight-multi-way-voucher.html',
})
export class FlightMultiWayVoucherPage {

  flightInfo; destinationDetails;loading;
  ...
  bool= false;
  map = {};gestDetails = [];bookingDetails = [];currencys;
  cityPair: string = "";departDate: Date = new Date();user;AllflightInfo;FlightAllMarkup;FlightAllFix;TXN_AMOUNT;
  constructor(public navCtrl: NavController, public navParams: NavParams,public loadingCtrl: LoadingController,
    ...
    public jsonSearchProvider:JsonSearchProvider ) {
      ...
      console.log("AllflightInfo",this.AllflightInfo)
  ...
  ionViewDidLoad() {
    // this.flightBook();
    console.log('ionViewDidLoad FlightMultiWayVoucherPage');
  }
  ...
  // flightBook() 
  // {
  //   this.flightProvider.flightBookMulti(
